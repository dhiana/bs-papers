...
Eventos com este fenômeno podem ser chamados de "eventos fantasmas" e não deverão ser levados em consideração para análises de eficiência dos algoritmos, uma vez que não estarão presentes em rodadas de colisionamento de partículas.
